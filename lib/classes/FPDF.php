...
class FPDF
{
	...
	*******************************************************************************/
	...
	public function getPercX($x)
	{
		return ($x * 6 / $this->k) - ($this->k / 2);
	}
	...
	public function FixY($y, $lineHeight)
	{
	...
	public function AddFixY($add, $lineHeight)
	{
		return $this->FixY($this->GetY() + $add, $lineHeight);
	}

	public function getPercY($y)
	{
		return $y * 8.4 / $this->k;
	}
	...
	*******************************************************************************/
	...
	protected function _toAnsi($s)
	{
		$prev = mb_detect_encoding($s);
		if ($prev == 'UTF-8') {
